...
# Tech Tok build configuration file, created by
# `ablog start` on Wed Dec 23 03:03:44 2020.
#
...
blog_authors = {
    'Alison Mukoma': ('Alison Mukoma', None),
}
...
project = u'Tech Tok'
copyright = u'2020, Alison Mukoma'
author = u'Alison Mukoma'
...
htmlhelp_basename = 'TechTokdoc'

github_pages = 'sonlinux'
